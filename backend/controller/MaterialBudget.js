...
exports.getOne = async (req, res) => {
  try {
    ...
    console.log("🧾 Danh sách MaterialBudget hiện có:");
    const all = await MaterialBudget.find({}, "_id code productionScope");
    console.log(all);
    ...
    if (!materialbudget) {
      return res.status(404).json({
        status: "error",
        message: "Không tìm thấy MaterialBudget với ID này.",
      });
    }
