...
exports.update = async (req, res) => {
    try {
        const updateData = await CrossSection.findByIdAndUpdate(req.params.id, req.body, { new: true })
        if (!updateData) {
...
exports.get = async (req, res) => {
    try {
        ...
        const pagination = await paginateQuery(CrossSection, modelQuery, query, req.query)
