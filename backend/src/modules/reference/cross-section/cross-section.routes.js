...
const CrossSectionController = require('./cross-section.controller');
const { verifyToken } = require('../../../shared/middleware/auth.middleware');
const { validateBody, validateParams } = require('../../../shared/middleware/validation.middleware');
const { createSchema, updateSchema, idSchema, deleteManySchema } = require('./cross-section.validation');

const ctrl = new CrossSectionController();
