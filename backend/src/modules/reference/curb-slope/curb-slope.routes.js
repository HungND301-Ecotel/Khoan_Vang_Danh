...
const CurbSlopeController = require('./curb-slope.controller');
const { verifyToken } = require('../../../shared/middleware/auth.middleware');
const { validateBody, validateParams } = require('../../../shared/middleware/validation.middleware');
const { createSchema, updateSchema, idSchema, deleteManySchema } = require('./curb-slope.validation');

const ctrl = new CurbSlopeController();
