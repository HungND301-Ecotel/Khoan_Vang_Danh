import { Box, Paper, Table as TableMui, TableHead, TableRow, TableCell, TableBody } from "@mui/material";
...
const groupMaterialsByAssignmentCode = (materials: any[]) => {
  ...
  materials.forEach((mat: any) => {
    ...
    const assignmentCode = material?.assignmentCode || null;
    const assignmentCodeValue = assignmentCode?.code || "";
    const price = material?.assignmentCode ? mat.price : "";
    const compoundKey = assignmentCode ? `${assignmentCodeValue}_${price}` : `no_ac_${mat.material?._id || mat._id}`;
