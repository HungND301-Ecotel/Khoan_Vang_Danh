...
const STATIC_INDICATORS: StaticIndicatorItem[] = [
  ...
  {
    stt: "1",
    label: "Than Nguyên Khai khai thác",
    unit: "Tấn",
    isGroup: false,
    isSubGroup: false,
    isBold: true,
  ...
  {
    stt: "",
    label: "- Lò chợ giá khung (ZH, GK, Xích)",
    unit: '"',
    isGroup: false,
    isSubGroup: false,
    isBold: false,
  ...
  {
    stt: "",
    label: "- Lò chợ khai thác phần tầng NN",
    unit: '"',
    isGroup: false,
    isSubGroup: false,
    isBold: false,
...
export default function TechnologyKPIReport() {
  ...
  const initialValues: IndicatorValues = STATIC_INDICATORS.reduce(
    (acc, item, index) => {
  ...
  const [inputValues, setInputValues] =
    useState<IndicatorValues>(initialValues);
