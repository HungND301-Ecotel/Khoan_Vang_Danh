...
const MATERIAL_CONSUMPTION: MaterialItem[] = [
    { id: 'KT10', label: 'Gỗ chèn Ф8-12, L=2.2-2.4m', unit: 'm²', unitPrice: 1054.664 },
    { id: 'KT11', label: 'Gỗ chèn Ф13-17, L=2-2.5m', unit: 'm²', unitPrice: 1269.690 },
    { id: 'KT12', label: 'Thuốc nổ NTLT-2', unit: 'kg', unitPrice: 42.578 },
    { id: 'KT13', label: 'Thuốc nổ NTLĐ-2', unit: 'kg', unitPrice: 38.250 },
    ...
    { id: 'KT19', label: 'Mũi khoán khi ép', unit: 'cái', unitPrice: 260.000 },
    ...
    { id: 'KT23', label: 'Cột giả thủy lực', unit: 'cột', unitPrice: 9150.000 },
    { id: 'KT24', label: 'Dầu nhờn hóa', unit: 'lít', unitPrice: 69.760 },
    { id: 'KT25', label: 'Xẻng xúc than', unit: 'cái', unitPrice: 51.000 },
    { id: 'KT26', label: 'Cuốc chà nhọn 2 đầu', unit: 'cái', unitPrice: 82.000 },
    { id: 'KT27', label: 'Choòng phòng than', unit: 'cái', unitPrice: 72.846 },
    { id: 'KT28', label: 'Túi ba lô đựng thuốc mìn', unit: 'cái', unitPrice: 203.671 },
    { id: 'KT29', label: 'Hòm đựng thuốc kíp', unit: 'cái', unitPrice: 1907.990 },
    { id: 'KT30', label: 'Cáp thép buộc đầu cột Ф7-8', unit: 'm', unitPrice: 12.000 },
];
// --- End Data ---
...
const calculateValue = (material: MaterialItem, count: string | number): number => {
...
export default function ProductionPhaseReport() {
    ...
    // Khởi tạo state
    const initialValues: MaterialValues = MATERIAL_CONSUMPTION.reduce((acc: MaterialValues, item) => {
        acc[item.id] = {};
    ...
    const handleInputChange = (id: string, fieldName: string, value: string) => {
        ...
        if (fieldName === 'thucHien_SoLuong') {
            ...
            if (soLuongKeHoach !== '') {
                updatedValues.soSanh_SoLuong = (soLuong as number) - (soLuongKeHoach as number);
            }
            ...
            if (giaTriKeHoach !== '') {
                updatedValues.soSanh_GiaTri = (giaTriThucHien as number) - (giaTriKeHoach as number);
            }
        }
                ...
                <Table size="small" stickyHeader>
                    <TableHead>
                        ...
                        <TableRow sx={{ backgroundColor: '#e0f0ff' }}>
                            <TableCell rowSpan={3} align="center" sx={{ border: '1px solid #a8a8a4ff' }}>Mã giao khoán</TableCell>
                            <TableCell rowSpan={3} align="center" sx={{ minWidth: 300, border: '1px solid #a8a8a4ff' }}>Tên vật tư, tài sản</TableCell>
                            <TableCell rowSpan={3} align="center" sx={{ border: '1px solid #a8a8a4ff' }}>ĐVT</TableCell>
                            <TableCell rowSpan={3} align="center" sx={{ minWidth: 100, border: '1px solid #a8a8a4ff' }}>Đơn giá (VNĐ)</TableCell>

                            <TableCell colSpan={9} align="center" sx={{ minWidth: 100, border: '1px solid #a8a8a4ff' }}>Khấu lò chợ ZH, ZRY</TableCell>

                        </TableRow>

                        <TableRow>
                            <TableCell rowSpan={2} align="center" sx={{ border: '1px solid #a8a8a4ff' }}>Khối lượng</TableCell>
                            <TableCell colSpan={3} align="center" sx={{ border: '1px solid #a8a8a4ff' }}>Kế hoạch</TableCell>
                            <TableCell colSpan={2} align="center" sx={{ border: '1px solid #a8a8a4ff' }}>Thực hiện</TableCell>
                            <TableCell colSpan={2} align="center" sx={{ border: '1px solid #a8a8a4ff' }}>So sánh</TableCell>
                            <TableCell rowSpan={2} align="center" sx={{ border: '1px solid #a8a8a4ff' }}>Ghi chú</TableCell>
                        </TableRow>
                        {/* Hàng tiêu đề 2 */}
                        <TableRow sx={{ backgroundColor: '#e0f0ff' }}>
                            <TableCell align="center" sx={{ border: '1px solid #a8a8a4ff' }}>ĐM</TableCell>
                            <TableCell align="center" sx={{ border: '1px solid #a8a8a4ff' }}>Số lượng</TableCell>
                            <TableCell align="center" sx={{ border: '1px solid #a8a8a4ff' }}>Giá trị</TableCell>
                            <TableCell align="center" sx={{ border: '1px solid #a8a8a4ff' }}>Số lượng</TableCell>
                            <TableCell align="center" sx={{ border: '1px solid #a8a8a4ff' }}>Giá trị</TableCell>
                            <TableCell align="center" sx={{ border: '1px solid #a8a8a4ff' }}>Số lượng</TableCell>
                            <TableCell align="center" sx={{ border: '1px solid #a8a8a4ff' }}>Giá trị</TableCell>
                    ...
                    <TableBody>
                        {MATERIAL_CONSUMPTION.map((row) => (
                            <TableRow key={row.id}>
                                <TableCell align="center" sx={{ fontWeight: 'bold', border: '1px solid #a8a8a4ff' }}>{row.id}</TableCell>
                                <TableCell sx={{ border: '1px solid #a8a8a4ff' }}>{row.label}</TableCell>
                                <TableCell align="center" sx={{ border: '1px solid #a8a8a4ff' }}>{row.unit}</TableCell>
                                <TableCell align="right" sx={{ fontWeight: 'bold', border: '1px solid #a8a8a4ff' }}>{row.unitPrice.toLocaleString('vi-VN')}</TableCell>
                                ...
                                <TableCell align="right" sx={{ fontWeight: 'bold', color: 'blue', border: '1px solid #a8a8a4ff' }}>
                                ...
                                <TableCell align="right" sx={{ fontWeight: 'bold', color: 'green', border: '1px solid #a8a8a4ff' }}>
                                    {getCellValue(row.id, 'thucHien_GiaTri')}
                                </TableCell>

                                {/* 3. So sánh (Chỉ hiển thị) */}
                                <TableCell align="right" sx={{ fontWeight: 'bold', color: 'orange', border: '1px solid #a8a8a4ff' }}>
                                    {getCellValue(row.id, 'soSanh_SoLuong')}
                                </TableCell>
                                <TableCell align="right" sx={{ fontWeight: 'bold', color: 'red', border: '1px solid #a8a8a4ff' }}>
