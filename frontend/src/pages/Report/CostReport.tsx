...
const COST_INDICATORS: CostIndicatorItem[] = [
  ...
  {
    stt: "3",
    label: "Dầu nhũ hóa ( cột thủy lực )",
    unit: "lit/1000T",
    isGroup: false,
    isSubGroup: false,
    isDetail: false,
...
export default function CostReport() {
  ...
  const initialValues: CostValues = COST_INDICATORS.reduce(
    (acc: CostValues, item, index) => {
          ...
          <TableHead>
            ...
            <TableRow sx={{ backgroundColor: "#e0f0ff" }}>
              <TableCell
                rowSpan={2}
                align="center"
                sx={{ width: 50, border: "1px solid #a8a8a4ff" }}
              >
                TT
              </TableCell>
              <TableCell
                rowSpan={2}
                align="center"
                sx={{ minWidth: 250, border: "1px solid #a8a8a4ff" }}
              >
                Yếu tố chi phí
              </TableCell>
              <TableCell
                rowSpan={2}
                align="center"
                sx={{ width: 70, border: "1px solid #a8a8a4ff" }}
              >
                ĐVT
              </TableCell>
              ...
              <TableCell
                ...
                sx={{ border: "1px solid #a8a8a4ff" }}
              >
                SS với bình quân 3 năm liền kề (%)
              </TableCell>
            </TableRow>
            ...
            {COST_INDICATORS.map((row, index) => {
              ...
              return (
                <TableRow key={uniqueId}>
                  ...
                  <TableCell
                    align="center"
                    sx={{ fontStyle: "italic", border: "1px solid #a8a8a4ff" }}
                  >
                    {row.unit}
                  </TableCell>
