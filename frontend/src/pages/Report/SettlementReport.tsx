...
const SETTLEMENT_INDICATORS: SettlementItem[] = [
  ...
  },
  {
    id: "B6_1",
    stt: "-",
    label: "Chi phí ăn định lượng, ăn giữa ca và bồi dưỡng độc hại",
    unit: "Đồng",
    isGroup: false,
    isSubGroup: false,
    isBold: false,
...
export default function SettlementReport() {
  ...
  const initialValues: SettlementValues = SETTLEMENT_INDICATORS.filter(
    (item) => item.isInput,
  ...
  const [inputValues, setInputValues] =
    useState<SettlementValues>(initialValues);
  ...
  const getCalculatedValue = (
    id: string,
    column: "giaThanh" | "thanhTien" | "chechLech",
    isKeHoach: boolean = true,
  ) => {
