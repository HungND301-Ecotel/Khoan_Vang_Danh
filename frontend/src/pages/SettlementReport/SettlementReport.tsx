          ...
          >
            ...
            <TableBody>
              ...
              <TableRow>
                <TableCell
                  align="center"
                  sx={{ border: "1px solid #ddd", fontWeight: "bold", p: 0.5 }}
                >
                  1
                </TableCell>
                <TableCell
                ...
                return (
                  <Fragment key={assignment.compoundKey}>
                    ...
                    {Array.from({ length: assignment.maxRows }).map((_, i) => {
                      ...
                      const globalDuplicateCount = materialUsedRef.material?._id
                      ...
                      return (
                        <TableRow
                          ...
                          sx={{
                            opacity:
                              draggingItemId === materialUsedRef.materialItemId
                                ? 0.4
                                : 1,
                            cursor: canDragDrop ? "grab" : "default",
                            "&:active": {
                              cursor: canDragDrop ? "grabbing" : "default",
                            },
                            transition:
                        ...
                        >
                          ...
                          {blockKeys.map((bk, idx) => {
                            ...
                            const blockId = getBlockId(bk.month, bk.phaseId);
                            const mu =
                              assignment.blocks.get(blockId)?.materialUseds?.[
                                i
                              ];
