...
import { AssignmentCodeInputType, MaterialAssignmentInputType, MaterialAssignmentOutputType, Materials } from '../../types'
...
export default function Materialunitprice() {
  ...
  const { data: materialAssignments = [] } = useQuery({
    ...
    queryFn: () => api.get('/materialassignments').then(res => setData(res.data.data))
  })
