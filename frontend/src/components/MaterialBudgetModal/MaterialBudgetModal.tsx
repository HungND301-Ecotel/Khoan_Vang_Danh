...
import {
  ...
  CoalCuttingNormKBOutputType,
  ExcavationNormInputType,
  ExcavationNormOutputType,
  ExcavationTechType,
  HardnessType,
          ...
          <Box component="form" onSubmit={formik.handleSubmit} sx={{ mt: 2 }}>
            <Box sx={{ display: "flex", flexDirection: "column", gap: 2 }}>
              ...
              <TextField
                ...
                error={
                  formik.touched.production && Boolean(formik.errors.production)
                }
                helperText={
              ...
              <TextField
                ...
                error={
                  formik.touched.assignmentNormCode &&
                  Boolean(formik.errors.assignmentNormCode)
                }
                helperText={
                  formik.touched.assignmentNormCode &&
                  formik.errors.assignmentNormCode
                }
              >
              ...
              <TextField
                fullWidth
                select
                label="Mã định hệ số điều chỉnh định mức"
                variant="outlined"
                ...
                error={
                  formik.touched.adjustmentNormCode &&
                  Boolean(formik.errors.adjustmentNormCode)
                }
                helperText={
                  formik.touched.adjustmentNormCode &&
                  formik.errors.adjustmentNormCode
                }
              >
