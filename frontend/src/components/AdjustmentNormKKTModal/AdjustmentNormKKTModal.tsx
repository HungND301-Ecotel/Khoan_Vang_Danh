...
export default function AdjustmentNormKKTModal({ open, setOpen, handleSubmit, selected }: { open: boolean; setOpen: Dispatch<SetStateAction<boolean>>; handleSubmit: (values: Partial<AdjustmentNormKInputType>) => void; selected: AdjustmentNormKOutputType | null }) {
