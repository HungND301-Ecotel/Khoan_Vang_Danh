...
export default function RockRatioModal({
  open,
  setOpen,
  handleSubmit,
  selectedRockRatio,
    ...
    >
      ...
      <DialogTitle sx={{ p: 0, mt: "16px" }}>
        <Breadcrumbs aria-label="breadcrumb" sx={{ fontSize: "14px" }}>
          ...
          <Typography>Tỉ lệ đá lẫn trong gương (Ckẹp)</Typography>
        </Breadcrumbs>
        <Divider
          style={{
            margin: "10px 0",
        ...
        <Typography sx={{ fontSize: "24px", color: "#2B4A82" }}>
          {selectedRockRatio ? "Chỉnh sửa Tỷ lệ đá lẫn trong gương" : "Tạo mới Tỷ lệ đá lẫn trong gương"}
        </Typography>
      </DialogTitle>
      ...
      <DialogContent sx={{ p: 0, mt: 3 }}>
        <Box component="form" onSubmit={formik.handleSubmit} sx={{ display: "flex", justifyContent: "center" }}>
          <Box sx={{ display: "flex", flexDirection: "column", gap: 2, width: "700px" }}>
            <Box>
              <Typography sx={{ fontWeight: 500, fontSize: "14px", mb: 1 }}>Tỉ lệ</Typography>
              <TextField
                fullWidth
                id="name"
                name="name"
